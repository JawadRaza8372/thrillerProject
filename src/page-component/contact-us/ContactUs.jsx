...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (data.email === "") {
      ...
      axios({
        method: "post",
        url: "https://upload.appick.io",
        data: formData,
        headers: {
          "Content-Type": "multipart/form-data",
        },
      }).then((resp) => {
        resp.data.myresp.forEach((item) => {
          attachments.push(item.path);
        });
        var config = {
          method: "post",
          url: "https://api.thrillerme.com/zendesk/create",
          ...
          data: {
            ...
            body: `
              ...
              data.questionsAbout !== null
                ? `I have questions about ${data.questionsAbout},`
                : ""
            } ${
              data.furtherQuestionsAbout !== ""
                ? `I have further questions about ${data.furtherQuestionsAbout}.`
                : ""
        ...
        <div className={classes.requestForm}>
            ...
            <FormControl fullWidth className={classes.formFieldSection}>
              ...
              <select
                ...
                onChange={(e) => {
                  setData({
                    ...data,
                    furtherQuestionsAbout: e.target.value,
                  });
                }}
              >
                {data.questionsAbout !== null &&
          ...
          <FormControl fullWidth className={classes.formFieldSection}>
            ...
            <span style={{ fontSize: "12px" }}>
              ...
              team will respond to you as soon as possible. *Estimated wait
              time: About 6 hours*
            </span>
          </FormControl>
          <FormControl fullWidth className={classes.formFieldSection}>
